                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="restore_height_txt" type="text" class="form-control" style="display:none; float:right; width: 100px" value="0"/> <label for="restore_height_txt" style="font-weight: bold; float:right; margin-right:20px;display:none;">Restore from height#</label>
                        </div>
                    </div>
                </div>
                <div class="row">
